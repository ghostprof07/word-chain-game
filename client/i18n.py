...
CEVIRILER = {
    ...
    'en': {
        ...
        'best_word': 'Best word', 'reset': 'Reset',
        'settings': 'Settings',
    ...
    'tr': {
        ...
        'best_word': 'En iyi kelime', 'reset': 'Sıfırla',
        'settings': 'Ayarlar',
    ...
    'de': {
        ...
        'best_word': 'Bestes Wort', 'reset': 'Zurücksetzen',
    ...
    'es': {
        ...
        'best_word': 'Mejor palabra', 'reset': 'Reiniciar',
        'settings': 'Ajustes',
    ...
    'fr': {
        ...
        'best_word': 'Meilleur mot', 'reset': 'Réinitialiser',
        'settings': 'Paramètres',
    ...
    'ru': {
        ...
        'best_word': 'Лучшее слово', 'reset': 'Сбросить',
        'settings': 'Настройки',
