...
CEVIRILER = {
    ...
    'en': {
        ...
        'tap_for_meaning': 'Tap a word for its meaning',
        'loading': 'Loading...',
        'no_definition': 'No definition found.',
        'definition_error': 'Could not fetch the definition — check your '
                            'internet connection.',
        'vs_bot': 'vs Bot',
        'training': 'Training',
    ...
    'tr': {
        ...
        'tap_for_meaning': 'Anlamı için kelimeye dokun',
        'loading': 'Yükleniyor...',
        'no_definition': 'Anlam bulunamadı.',
        'definition_error': 'Anlama ulaşılamadı — internet bağlantınızı '
                            'kontrol edin.',
        'vs_bot': 'Bot\'a Karşı',
        'training': 'Antrenman',
    ...
    'de': {
        ...
        'tap_for_meaning': 'Tippe auf ein Wort für die Bedeutung',
        'loading': 'Wird geladen...',
        'no_definition': 'Keine Definition gefunden.',
        'definition_error': 'Definition nicht abrufbar — prüfe deine '
                            'Internetverbindung.',
        'vs_bot': 'Gegen Bot',
        'training': 'Training',
    ...
    'es': {
        ...
        'tap_for_meaning': 'Toca una palabra para ver su significado',
        'loading': 'Cargando...',
        'no_definition': 'No se encontró definición.',
        'definition_error': 'No se pudo obtener la definición — comprueba '
    ...
    'fr': {
        ...
        'tap_for_meaning': 'Touchez un mot pour voir sa définition',
        'loading': 'Chargement...',
        'no_definition': 'Aucune définition trouvée.',
        'definition_error': 'Définition indisponible — vérifiez votre '
                            'connexion internet.',
        'vs_bot': 'vs Bot',
    ...
    'ru': {
        ...
        'tap_for_meaning': 'Нажми на слово, чтобы узнать значение',
        'loading': 'Загрузка...',
        'no_definition': 'Определение не найдено.',
        'definition_error': 'Не удалось получить определение — проверьте '
