...
CEVIRILER = {
    ...
    'tr': {
        ...
        'solo_play': 'TEK KİŞİLİK',
        'solo_title': 'TEK KİŞİLİK OYUN',
        'vs_bot': 'Bot\'a Karşı',
        'training': 'Antrenman',
    ...
    'de': {
        ...
        'solo_play': 'ALLEIN SPIELEN',
        'solo_title': 'ALLEIN SPIELEN',
        'vs_bot': 'Gegen Bot',
        'training': 'Training',
    ...
    'es': {
        ...
        'solo_play': 'JUGAR SOLO',
        'solo_title': 'JUGAR SOLO',
        'vs_bot': 'vs Bot',
    ...
    'fr': {
        ...
        'solo_play': 'JOUER SOLO',
        'solo_title': 'JOUER SOLO',
        'vs_bot': 'vs Bot',
